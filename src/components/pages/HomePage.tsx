...
const HomePage: React.FC = () => {
  ...
  <section className="relative min-h-screen flex items-start pt-28 pb-10 md:pt-0 md:pb-0 md:items-center">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-black/20 md:bg-black/60" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
          <div className="max-w-2xl">
            ...
            <p className="text-xl md:text-2xl text-[#F5F3E7]/80 mb-8 ml-10 md:ml-0 max-w-lg font-medium hidden md:block">
